...
def testSystemIdentificationSVD():
    ...
    for i in range(len(system.causal_system.stages)):
        ...
        assert np.allclose(I_ref, I_rec), "INF causal part not correct"
        ...
        assert np.allclose(I_ref, I_rec), "INF anticausal part not correct"
    ...
    for i in range(len(system.causal_system.stages)):
        ...
        assert np.allclose(I_ref, I_rec), "ONF causal part not correct"
        ...
        assert np.allclose(I_ref, I_rec), "ONF anticausal part not correct"
